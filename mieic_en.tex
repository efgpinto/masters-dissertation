...
%%----------------------------------------
\title{Information Systems Architecture Definition for the Portuguese Electronic Health Record}
\author{Eduardo Filipe Garcia Pinto}

%% Uncomment next line for date of submission
\thesisdate{13\textsuperscript{rd} July, 2012}

%%Uncomment next line for copyright text if used
%\copyrightnotice{Eduardo Filipe Garcia Pinto, 2012}
...
\committeemember{Chair}{Doctor Gabriel de Sousa Torcato David}
\committeemember{External Examiner}{Doctor Carlos Manuel Azevedo Costa}
\committeemember{Supervisor}{Doctor António Ernesto da Silva Carvalho Brito}
\signature
