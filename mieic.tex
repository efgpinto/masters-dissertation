...
%%----------------------------------------
\title{Definição de uma arquitetura para os Sistemas de Informação da saúde com aplicação ao Registo de Saúde Eletrónico}
...
\supervisor{Orientador}{Nome do Orientador}{(Título)}
%% Uncomment next line if necessary
%\supervisor{Co-orientador}{Nome de Outro Orientador}{(T\'itulo)}

%% Committee stuff for final version
\committeetext{Aprovado em provas públicas pelo júri:}
\committeemember{Presidente}{Nome do Presidente}{(Título)}
\committeemember{Vogal Externo}{Nome do Arguente}{(Título)}
\committeemember{Orientador}{Nome do Orientador}{(Título)}
\signature
